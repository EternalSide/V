        ...
        <section className="flex w-full justify-start gap-0 max-lg:mt-6 max-sm:mt-0 ">
          <div className="w-[285px] pt-20 max-lg:hidden">
            <div className="flex items-center justify-between">
              <Link href="/create">
                <button className="button ml-3 bg-indigo-600 text-white">
                  Новый пост
                </button>
              </Link>
            </div>
          ...
          <div className="flex flex-1 flex-col border-l border-neutral-800 pt-16 max-lg:border-l-transparent max-sm:pt-6">
