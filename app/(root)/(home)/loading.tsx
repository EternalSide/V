...
const Loading = () => {
	return (
		<div className='mx-auto flex w-full max-w-7xl gap-3 max-lg:gap-0 h-full'>
			<div className='h-full sticky left-0 top-0 flex flex-col gap-8 overflow-y-auto border-neutral-700 max-lg:pl-4 pt-[95px] max-lg:h-full max-lg:border-r max-lg:px-2 max-sm:hidden lg:w-[254px]'>
