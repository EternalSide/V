				...
				<FormField
					...
					render={({field}) => (
						<FormItem className='max-w-3xl'>
							...
							<FormDescription className='pl-1 text-neutral-400'>Имя тега пока-что нельзя менять.</FormDescription>
				...
				<FormField
					...
					render={({field}) => (
						<FormItem className='max-w-3xl'>
							...
							<FormDescription className='pl-1 text-neutral-400'>Описание для вашего тега</FormDescription>
							<FormMessage className='text-indigo-500' />
						</FormItem>
					)}
				/>
